...
function attentionAdd(beuserid) {
    ...
    $.ajax({
        ...
        url: APP_PATH + "/zheye-forum/attention/setAttention" ,
        data: data,
...
function attentionDel(beuserid) {
    $.ajax({
        ...
        type: "delete",//方法类型
        dataType: "json",//预期服务器返回的数据类型
        url: APP_PATH + "/zheye-forum/attention/deleteByUserid/" + beuserid ,
        success: function (data) {
            // 状态码
            var code = data.code;
            // 提示信息
...
function attentionDelMyself(beuserid, gid) {
    $.ajax({
        ...
        type: "delete",//方法类型
        dataType: "json",//预期服务器返回的数据类型
        url: APP_PATH + "/zheye-forum/attention/deleteAttention/" + gid ,
        success: function (data) {
            // 状态码
            var code = data.code;
            // 提示信息
