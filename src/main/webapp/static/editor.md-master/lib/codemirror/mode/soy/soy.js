...
(function(mod) {
  ...
  var indentingTags = ["temboard", "literal", "msg", "fallbackmsg", "let", "if", "elseif",
                       "else", "switch", "case", "default", "foreach", "ifempty", "for",
                       "call", "param", "deltemboard", "delcall", "log"];
    ...
    return {
      ...
      token: function(stream, state) {
        ...
        switch (last(state.soyState)) {
          ...
          case "tag":
            if (stream.match(/^\/?}/)) {
              if (state.tag == "/temboard" || state.tag == "/deltemboard") state.indent = 0;
      ...
      indent: function(state, textAfter) {
        ...
        if (top == "literal") {
          ...
          if (/^\s*\{\/(temboard|deltemboard)\b/.test(textAfter)) return 0;
      ...
      electricInput: /^\s*\{(\/|\/temboard|\/deltemboard|\/switch|fallbackmsg|elseif|else|case|default|ifempty|\/literal\})$/,
      lineComment: "//",
      blockCommentStart: "/*",
      blockCommentEnd: "*/",
